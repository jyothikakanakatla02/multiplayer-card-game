...
from .views import create_room_view,join_room,room_state,leave_room,start_game,select_identity_api,complete_identity_api,pass_card,get_player_hand_api,force_finish_round_api,reset_round_api,participate_in_star_api
urlpatterns = [
